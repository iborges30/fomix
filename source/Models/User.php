...
class User extends Model
{
    ...
    {
        parent::__construct("users", ["id"], ["first_name", "last_name", "document", "email", "password"]);
    }
    ...
    public function save(): bool
    {
        ...
        if (!empty($this->id)) {
            ...
            if ($this->find("email = :e AND id != :i", "e={$this->email}&i={$userId}", "id")->fetch()) {
                $this->message->warning("O e-mail informado já está cadastrado". $this->document);
                return false;
            }
        ...
        if (empty($this->id)) {
            ...
            if ($this->find("document = :d ", "d={$this->document}", "id")->fetch()) {
                $this->message->warning("O CPF / CNPJ informado já está cadastrado");
                return false;
            }
