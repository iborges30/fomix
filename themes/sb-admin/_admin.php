  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= url("/admin/dash/home"); ?>">
        ...
        <div class="sidebar-brand-text mx-3">FOMIX</div>
      </a>
   ...
   <!-- Divider -->
      ...
      <div class="sidebar-heading">
        ...
        <hr class="sidebar-divider">
        <li class="nav-item">
            <a class="nav-link jsc-status-shop" data-shop-status="<?= $shop->status == 'open' ? "close" : 'open'; ?>" href="<?= url("/admin/dash/status-shop"); ?>">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="<?= url("/admin/enterprise/user/update/" . base64_encode(user()->id)); ?>">
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; CSW - SOLUÇÕES WEB</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
