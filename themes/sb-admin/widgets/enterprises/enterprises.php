            ...
            <div class="col-lg-12 order-lg-1">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= url("/admin/enterprise/create"); ?>" method="post">
                            <input type="hidden" name="action" value="create"/>
                            <div class="pl-lg-1">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group focused">
                                            <label class="form-control-label" for="name">Empresa</label>
                                            <input type="text" id="name" class="form-control" name="enterprise" required
                                                   placeholder="Nome do restaurante">
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="form-group focused">
                                            <label class="form-control-label" for="last_name">Cnpj</label>
                                            <input type="text" required class="form-control mask-document-enterprise"
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group focused">
                                            ...
                                            <input type="text" id="last_name" class="form-control mask-phone" required
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="form-control-label" for="email">Endereço</label>
                                    ...
                                    <div class="col-lg-2">
                                        <div class="form-group focused">
                                            <label class="form-control-label">Número
                                            </label>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group focused">
                                            <label class="form-control-label">
                                                Complmento</label>
                                            <input type="text" class="form-control" required name="complement">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group focused">
                                            <label class="form-control-label">
                                                Cep</label>
                                            <input type="text" class="form-control wc_getCep mask-zip-code" required
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group focused">
                                            <label class="form-control-label">
                                                Cidade</label>
                                            <input type="text" class="form-control wc_localidade" readonly="" required
                                                   name="city">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-2">
                                        <div class="form-group focused">
                                            <label class="form-control-label">
                                                Estado</label>
                                            <input type="text" class="form-control wc_uf" readonly="" required
                                                   name="state">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group focused">
                                            <label class="form-control-label">
                                               CPF</label>
                                            <input type="text" class="form-control mask-doc" name="document" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group focused">
                                            ...
                                            <select class="form-control" name="status">
                                                <option value="active" <?= $enterprise->status == 'active' ? 'selected' : ''; ?>>
                                                    Ativo
                                                </option>
                                                <option value="inactive" <?= $enterprise->status == 'inactive' ? 'selected' : ''; ?>>
                                                    Inativo
                                                </option>
                                            </select>
                                        </div>
