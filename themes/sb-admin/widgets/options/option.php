...
<div class="container-fluid">
    ...
    if (!$item) : ?>
        ...
        <form action="<?= url("/admin/options/option"); ?>" method="post">
            <!--ACTION SPOOFING-->
            <p><a href="<?= url("/admin/options/home"); ?>">Itens Opcionais</a></p>
            <input type="hidden" name="action" value="create" />

            <div class="form-row">
                <div class="form-group col-md-4">
                    <label for="first_name">Item opcional</label>
                    <input type="text" name="item" placeholder="Item opcional" class="form-control" required>
                </div>
                ...
                <div class="form-group col-md-4">
                    ...
                    <select id="inputState" name="status" class="form-control" required>
                        <?php
                        foreach (statusOptionsItems() as $key => $item) :
                        ?>
